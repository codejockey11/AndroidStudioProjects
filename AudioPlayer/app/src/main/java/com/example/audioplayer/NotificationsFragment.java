...
import com.example.audioplayer.databinding.FragmentNotificationsBinding;
...
public class NotificationsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        String path = ExternalStorageDirectory.GetSDCard(root.getContext());
        mActivityViewModel.LoadAudios(path + "/Music");
